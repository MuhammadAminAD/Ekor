  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className={cn('outline-none')}>
        <button
          className="flex items-center gap-[8px] border-[1px] border-[#006AFF]
        lg:py-[12px] lg:px-[20px] py-[9px] px-[16px] rounded-[15px] bg-transparent hover:bg-[#006AFF]
        lg:text-[20px] text-[14px] font-medium leading-[100%] text-[#006AFF] group hover:text-[#F9F9F9]
