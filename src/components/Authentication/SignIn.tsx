...
export default function SignIn() {
  ...
  return (
    <div>
      <h1 className={`${styles.text32_500} text-center mb-16`}>
        Profilga kirish
      </h1>
      ...
      <div>
        <Form {...form}>
          ...
          >
            ...
            <div className="mt-6">
              <button
                className="underline text-md cursor-pointer text-main-black"
                onClick={() => dispatch(setActiveAuthPage("reset-password"))}
              >
        ...
        <div className="w-full flex items-center my-12.5">
          ...
          <span className="px-2.5 text-[#999999] text-md font-medium">
            yoki
          </span>
          <span className="w-full h-[1px] border-2 border-[#D9D9D9]" />
        </div>
        ...
        <div className="grid grid-cols-2 gap-x-7.5">
          <button className="flex items-center gap-5 py-6 w-full border-1  border-disabled justify-center rounded-2xl active:scale-90 duration-100">
            <GoogleIcon />
            Google orqali tizimga kiring
          </button>
          <button className="flex items-center gap-5 py-6 w-full border-1  border-disabled justify-center rounded-2xl active:scale-90 duration-100">
            <FacebookIcon />
            Facebook orqali tizimga kiring
          </button>
        </div>
        ...
        <h2 className="w-full mt-12.5 text-center text-[#1C1C1C]">
          ...
          <button
            onClick={() => {
              dispatch(setActiveAuthPage("registration"));
            }}
