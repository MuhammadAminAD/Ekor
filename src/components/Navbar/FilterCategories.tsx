...
import { setCategories, toggleCategory } from "@/features/FilterCategoriesSlice";
        ...
        <ul className="flex justify-between items-center">
          {categories.slice(0, 9).map((cat) => (
            <li
              ...
              className={`text-[16px] font-medium text-[#1C1C1C] px-[16px] py-[8px] rounded-[15px] border-[1.5px] cursor-pointer transition
                ${
                  selected === cat.id
